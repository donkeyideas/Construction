-- ============================================================
-- 021: Update CMS page sections + fix emails
-- Pages existed from earlier seed but had empty sections.
-- This migration populates sections via UPDATE.
-- All emails → info@donkeyideas.com
-- ============================================================
...
SET sections = '[
  ...
  },
  {
    ...
    "content": {
      "items": [
        { "title": "Interactive Gantt Charts", "description": "Visualize project timelines with drag-and-drop Gantt charts. Set dependencies, track milestones, and identify critical path items to keep your schedule on track." },
        { "title": "Task Tracking & Assignments", "description": "Create, assign, and track tasks across your entire team. Set priorities, due dates, and dependencies. Get real-time notifications when tasks are completed or overdue." },
        { "title": "Daily Logs & Reports", "description": "Capture daily field activity including weather conditions, labor hours, equipment usage, deliveries, and work completed. Generate professional daily reports for stakeholders." },
        { "title": "RFI Management", "description": "Streamline Requests for Information with a centralized tracking system. Create, assign, and respond to RFIs with automatic numbering, due date tracking, and audit trails." },
        { "title": "Submittal Tracking", "description": "Manage the entire submittal workflow from creation to approval. Track review cycles, required approvals, and maintain a complete history of all submittal activity." },
        { "title": "Real-Time Collaboration", "description": "Keep your entire project team aligned with real-time updates, @mentions, comment threads, and instant notifications. Collaborate with owners, architects, and subs in one place." }
      ]
    },
    "order": 1,
    "visible": true
...
SET sections = '[
  ...
  },
  {
    ...
    "content": {
      "items": [
        { "title": "Lease Tracking & Management", "description": "Track every lease from signing through renewal. Monitor rent escalations, lease expirations, security deposits, and payment history with automated alerts for key dates." },
        { "title": "Maintenance Request Portal", "description": "Tenants submit maintenance requests through a self-service portal. Automatically route requests to the right team, track resolution times, and maintain a complete service history." },
        { "title": "Unit & Property Management", "description": "Manage your entire portfolio with detailed unit-level tracking. Record floor plans, amenities, condition reports, and occupancy status across all your properties." },
        { "title": "Tenant Portal", "description": "Give tenants a branded self-service portal to pay rent, submit maintenance requests, view lease documents, and communicate with property management. Reduce phone calls and emails." },
        { "title": "Vacancy & Turnover Tracking", "description": "Monitor vacancy rates across your portfolio. Track make-ready progress for vacant units, schedule showings, and streamline the leasing workflow from application to move-in." },
        { "title": "Financial Reporting", "description": "Generate rent rolls, income statements, and expense reports by property or portfolio. Track rent collection rates, operating expenses, and net operating income in real time." }
      ]
    },
    "order": 1,
    "visible": true
...
SET sections = '[
  ...
  },
  {
    ...
    "content": {
      "items": [
        { "title": "Job Costing", "description": "Track costs at the project, phase, and cost code level. Compare actual costs against budgets in real time. Identify overruns early with automated variance alerts and earned value analysis." },
        { "title": "Budget Management", "description": "Create detailed construction budgets with CSI cost codes. Manage original budgets, approved changes, revised budgets, and commitments. Track budget-to-actual across every line item." },
        { "title": "Invoicing & Billing", "description": "Generate AIA-style pay applications (G702/G703), progress invoices, and T&M billing. Track invoice approval workflows, retainage, and payment status from submission to collection." },
        { "title": "Accounts Payable", "description": "Process subcontractor and vendor invoices efficiently. Match invoices to purchase orders and contracts. Manage approval workflows, scheduled payments, and maintain a complete AP aging report." },
        { "title": "Lien Waiver Tracking", "description": "Automate lien waiver collection from subcontractors and suppliers. Track conditional and unconditional waivers for progress and final payments. Never miss a waiver before releasing payment." },
        { "title": "Change Order Management", "description": "Track change orders from request through approval with full cost impact analysis. Link change orders to budget revisions, subcontractor change orders, and owner billing automatically." }
      ]
    },
    "order": 1,
    "visible": true
...
SET sections = '[
  ...
  },
  {
    ...
    "content": {
      "items": [
        { "title": "Plan Room & Drawing Sets", "description": "Upload and organize drawing sets by discipline. Compare revisions side by side, overlay versions to spot changes, and ensure your team always works from the latest set." },
        { "title": "Version Control", "description": "Every document upload creates a new version with a complete audit trail. See who uploaded what and when. Roll back to previous versions at any time. Never lose track of document history." },
        { "title": "Markup & Annotations", "description": "Add markups, annotations, and comments directly on drawings and documents. Use pins, arrows, text, and shapes. Link markups to RFIs, punch list items, or daily log entries." },
        { "title": "Secure Cloud Storage", "description": "All documents are stored in encrypted cloud storage with automatic backups. Set granular permissions to control who can view, download, or edit each folder and document." },
        { "title": "Smart Search & Tagging", "description": "Find any document instantly with full-text search across file names, tags, and metadata. Organize documents with custom tags, folders, and filters. Search across all projects at once." },
        { "title": "Mobile Access", "description": "Access drawings and documents from the field on any device. View plans offline, add markups on your tablet, and sync changes when you reconnect. Built for construction site conditions." }
      ]
    },
    "order": 1,
    "visible": true
...
SET sections = '[
  {
    ...
    "content": {
      ...
      "subheadline": "We are building the operating system for construction companies and property managers."
    },
    "order": 0,
    "visible": true
  },
...
SET sections = '[
  ...
  },
  {
    "type": "text",
    "content": {
      "body": "Get in Touch\n\nWe would love to hear from you. Whether you are evaluating Buildwrk for your company, need help with your account, or want to share feedback, our team is ready to assist.\n\nGeneral Inquiries & Support\nEmail: info@donkeyideas.com\nResponse Time: Within 24 hours on business days\n\nFor urgent issues affecting your ability to use the platform, email info@donkeyideas.com with \"URGENT\" in the subject line and we will prioritize your request.\n\nSales Inquiries\nEmail: info@donkeyideas.com\n\nInterested in Buildwrk for your construction company or property management firm? Our team can walk you through the platform, answer your questions, and help you find the right plan for your business. We offer personalized demos for teams of all sizes.\n\nPartnerships & Integrations\nEmail: info@donkeyideas.com\n\nWe are always looking to partner with companies that share our mission of modernizing the construction industry. If you are a software vendor, consultant, or industry organization interested in working together, reach out to us."
    },
    "order": 1,
    "visible": true
  },
...
-- Also update the contact page meta description to use the new email
UPDATE cms_pages
SET meta_description = 'Contact the Buildwrk team for support, sales, or partnership inquiries. Email info@donkeyideas.com for help with construction and property management software.'
WHERE page_slug = 'contact';
