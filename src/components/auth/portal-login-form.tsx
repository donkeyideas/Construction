...
function LoginFormInner({
  ...
  return (
    <div className="auth-card">
      ...
      {searchParams.get("registration") === "closed" && !error && (
        <div className="auth-error" style={{ background: "rgba(245, 158, 11, 0.08)", borderColor: "rgba(245, 158, 11, 0.3)" }}>
          <span className="auth-error-icon" style={{ color: "#f59e0b" }}>
          ...
          <span className="auth-error-text" style={{ color: "#f59e0b" }}>
            Registration is currently closed. Please contact the administrator if you need an account.
          </span>
        </div>
      )}
