    ...
    entities: [
      ...
      },
      {
        ...
        columns: [
          ...
          { key: "last_maintenance_date", label: "Last Maintenance", required: false, type: "date" as const },
          { key: "next_maintenance_date", label: "Next Maintenance", required: false, type: "date" as const },
        ],
      },
    ],
  },
    ...
    entities: [
      ...
      },
      {
        ...
        columns: [
          ...
          { key: "description", label: "Description", required: false },
          { key: "status", label: "Status", required: false },
          { key: "total_cost", label: "Total Cost ($)", required: false, type: "number" as const },
          { key: "total_price", label: "Total Price ($)", required: false, type: "number" as const },
          { key: "margin_pct", label: "Margin %", required: false, type: "number" as const },
          { key: "overhead_pct", label: "Overhead %", required: false, type: "number" as const },
          { key: "profit_pct", label: "Profit %", required: false, type: "number" as const },
          { key: "project_name", label: "Project Name", required: false },
        ],
      },
    ],
    ...
    entities: [
      ...
      },
      {
        ...
        columns: [
          ...
          { key: "status", label: "Status", required: false },
          { key: "due_date", label: "Due Date", required: false, type: "date" as const },
          { key: "cost_impact", label: "Cost Impact ($)", required: false, type: "number" as const },
      ...
      },
      {
        ...
        requiresProject: true,
        columns: [
          { key: "submittal_number", label: "Submittal #", required: false },
          { key: "title", label: "Title", required: true },
          { key: "project_name", label: "Project Name", required: false },
          { key: "spec_section", label: "Spec Section", required: false },
          { key: "status", label: "Status", required: false },
          { key: "due_date", label: "Due Date", required: false, type: "date" as const },
          { key: "review_comments", label: "Review Comments", required: false },
        ],
      },
    ],
  },
    ...
    entities: [
      ...
      },
      {
        ...
        columns: [
          ...
          { key: "scheduled_date", label: "Scheduled Date", required: false, type: "date" as const },
          { key: "estimated_cost", label: "Estimated Cost ($)", required: false, type: "number" as const },
          { key: "actual_cost", label: "Actual Cost ($)", required: false, type: "number" as const },
          { key: "notes", label: "Notes", required: false },
        ],
      },
      {
        ...
        columns: [
          ...
          { key: "effective_date", label: "Effective Date", required: false, type: "date" as const },
          { key: "end_date", label: "End Date", required: false, type: "date" as const },
          { key: "vendor_name", label: "Vendor Name", required: false },
          { key: "notes", label: "Notes", required: false },
        ],
