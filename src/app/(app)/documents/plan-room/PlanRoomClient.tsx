...
import type { DocumentRow, DrawingSetRow, DocumentFolderRow } from "@/lib/queries/documents";
...
export default function PlanRoomClient({
  ...
  // ------- Folders (used by upload modal) -------
  const [folders] = useState<DocumentFolderRow[]>(initialFolders);
  ...
  // ------- Filtered documents (project, search) -------
  ...
  return (
    <div className="plan-room-shell">
      ...
      {/* Main Layout: Viewer + Right Panel */}
