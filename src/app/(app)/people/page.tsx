...
import { getContactsWithCertAlerts, getPeopleOverview, type ContactType } from "@/lib/queries/people";
...
export default async function PeopleDirectoryPage({
  ...
  const [contacts, overview] = await Promise.all([
    getContactsWithCertAlerts(supabase, companyId, {
      type: typeFilter,
      search: searchFilter,
    }),
    getPeopleOverview(supabase, companyId),
  ]);
