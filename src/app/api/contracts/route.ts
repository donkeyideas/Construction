  ...
  try {
    ...
    const { contract, error } = await createContract(
      ...
      userCtx.userId,
      {
        ...
        contract_number: body.contract_number?.trim() || undefined,
        ...
        party_contact_id: body.party_contact_id || undefined,
        contract_amount: body.contract_amount ? Number(body.contract_amount) : undefined,
        retention_pct: body.retention_pct != null ? Number(body.retention_pct) : undefined,
