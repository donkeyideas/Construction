...
export const systemMap: SystemDashboard[] = [
  ...
  // ──────────────────────────────────────────────
  {
    ...
    description:
      "Primary workspace for company owners, admins, project managers, foremen, and accountants. Covers projects, properties, financials, documents, people, CRM, and AI tools.",
        ...
        pages: [
          {
            ...
            roles: ["owner", "admin", "project_manager", "foreman", "accountant"],
          },
        ],
      },
      {
        ...
        pages: [
          {
            ...
            href: "/properties",
            status: "active",
            description: "Overview of all managed properties",
      ...
      },
      {
        ...
        pages: [
          ...
          },
          {
            ...
            status: "active",
            description: "Blueprints, drawings, and plan sets viewer",
            roles: ["owner", "admin", "project_manager", "foreman"],
          },
        ],
      },
